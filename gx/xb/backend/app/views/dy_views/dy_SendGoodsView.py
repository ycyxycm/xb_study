...
class dySendGoodsSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        return instance
#ViewSet
class dySendGoodsViewSet(APIView):
    def get(self,request):
        ...
        try:
            ...
            obj = models.dy_sendgoods.objects.filter(**parameters).all().order_by('-now_date')
            obj_ser = dySendGoodsSerializer(instance=obj, many=True)
