...
class pddRecordViewSet(APIView):
    def get(self, request):
        ...
        try:
            ...
            obj = models.pdd_day_record.objects.filter(**parameters).all().order_by('-now_date')
            obj_ser = pddRecordSerializer(instance=obj, many=True)
